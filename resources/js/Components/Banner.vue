...
<template>
    <div>
        <div v-if="show && message" :class="{ 'bg-neon-green-600': style == 'success', 'bg-red-700': style == 'danger' }">
            <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded-lg" :class="{ 'bg-neon-green-700': style == 'success', 'bg-red-600': style == 'danger' }">
                    ...
                    <div class="shrink-0 sm:ms-3">
                        <button
                            ...
                            :class="{ 'hover:bg-neon-green-700 focus:bg-neon-green-700': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger' }"
                            aria-label="Dismiss"
